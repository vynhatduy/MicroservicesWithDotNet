    ...
    const [menus, setMenu] = useState([
        ...
        },
        {
            ...
            child: [
                ...
                {
                    name: "Dung dịch / Siro uống",
                    path: "/san-pham/byCategoryId/2"
                },
                {
                    name: "Dung dịch tiêm / Hỗn dịch tiêm",
                    path: "/san-pham/byCategoryId/3"
                },
                {
                    name: "Thuốc tiêm",
                    path: "/san-pham/byCategoryId/4"
                },
            ]
        },
        {
                                ...
                                <li>
                                    ...
                                    <div className="container-sub-menu">
                                        ...
                                        <div className={token !== null && token !== "null" && token !== undefined && decodeToken !== null ? "sub-menu visible" : "sub-menu hidden"} >
                                            ...
                                            <Link onClick={(event) => { event.preventDefault(); localStorage.setItem('token', null); window.location.reload(); } }>Đăng xuất</Link>
                                        </div></div>
                                </li>
                            </ul>
                        </div>
